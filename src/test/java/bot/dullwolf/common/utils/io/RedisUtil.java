package bot.dullwolf.common.utils.io;


import bot.dullwolf.common.utils.PropertiesUtil;
import bot.dullwolf.common.utils.StringUtil;
...
public class RedisUtil {
    ...
    private RedisUtil() {
        if (pool == null) {
            String ip = PropertiesUtil.readKey("redisIp");
            String pass = PropertiesUtil.readKey("redisPass");
            int port = Integer.parseInt(PropertiesUtil.readKey("redisPort"));
            ...
            if(StringUtil.notEmpty(pass)){
                pool = new JedisPool(config, ip, port, 100000, pass);
            }else{
