package com.skill.bot.smartqq.client;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.skill.bot.smartqq.callback.MessageCallback;
import com.skill.bot.smartqq.constant.ApiURL;
import com.skill.bot.smartqq.model.*;
import com.skill.bot.xiaov.util.XiaoVs;
...
public class SmartQQClient implements Closeable {
    ...
    //日志
    private static Logger LOGGER = LoggerFactory.getLogger(SmartQQClient.class);
